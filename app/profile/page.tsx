...
export default function ProfilePage() {
  ...
  const dashboardLink = isProfessional ? '/dashboard/professional' : '/dashboard/client'
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 mb-6">
            ...
            <div className="mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
              <p className="text-xs text-blue-700 dark:text-blue-400">
                ℹ️ Your bank details are encrypted and only used to transfer your earnings. We never store your full card details.
              </p>
            </div>
          </div>
        )}
