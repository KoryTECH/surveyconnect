...
export default function ProfessionalsPage() {
  ...
  const filtered = professionals.filter(p => {
    ...
    const matchesSearch = search === '' || name.includes(search.toLowerCase()) || getProfessionLabel(profession).toLowerCase().includes(search.toLowerCase())
    const matchesProfession = filterProfession === '' || profession === filterProfession
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center">
        <div className="text-gray-500 dark:text-gray-400">Loading professionals...</div>
      </div>
    )
  }
