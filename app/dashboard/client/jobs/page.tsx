			...
			<div className="max-w-5xl mx-auto px-6 py-8">
				...
				{jobs.length === 0 ? (
					<div className="bg-white dark:bg-gray-900 rounded-2xl p-12 text-center border border-gray-100 dark:border-gray-800">
						...
						<Link href="/jobs/post" className="bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded-xl transition-colors">
							Post a Job
						</Link>
					</div>
				) : (
									...
									<div className="flex-1">
										...
										<div className="flex items-center gap-4 text-xs text-gray-400 dark:text-gray-500 flex-wrap">
											<span className="flex items-center gap-1">
												...
												{[job.location_city, job.location_country].filter(Boolean).join(", ") || "Remote"}
											</span>
											<span className="flex items-center gap-1">
