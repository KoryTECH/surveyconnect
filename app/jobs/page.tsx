...
import { MapPin, Calendar, Clock, DollarSign, User, Search, SlidersHorizontal } from "lucide-react";
...
export default function JobsPage() {
	...
	const filteredJobs = jobs.filter((job) => {
		...
		const matchesProfession = filterProfession === "" || job.profession_type === filterProfession;
	...
	const getProfessionLabel = (type: string) => {
		const labels: any = {
			land_surveyor: "Land Surveyor", gis_analyst: "GIS Analyst",
			drone_pilot: "Drone/UAV Pilot", cartographer: "Cartographer",
			photogrammetrist: "Photogrammetrist", lidar_specialist: "LiDAR Specialist",
